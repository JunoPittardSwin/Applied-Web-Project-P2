...
function defaultJobs($db) {
	...
	$db->execute_query("INSERT INTO jobs_ess_reqs (id, jobs_ref, ess_text)
	VALUES ('NULL', 'J0115', 'A relevant degree, or equivalent certification or training'),
	('NULL', 'J0115', 'Strong previous experience with cybersecurity and project maintenance'),
	('NULL', 'J0115', 'Knowledge of a range of languages and computer systems'),
	('NULL', 'J0201', 'Consistent and strong history of field-based cybersecurity response'),
	('NULL', 'J0201', 'Deep understanding of current, deprecated, and potential attack vectors'),
	('NULL', 'J0201', 'Availability to be on-call for emergencies'),
	('NULL', 'J0302', 'Understanding of common cyber attacks and how to avoid vulnerability'),
	('NULL', 'J0302', 'People skills and an enthusiasm for communication'),
	('NULL', 'J0302', 'Demonstrated history of coordination or outreach measures');
	");

	// populate preferred requirements table with default data
	$db->execute_query("INSERT INTO jobs_pref_reqs (id, jobs_ref, pref_text)
		VALUES ('NULL', 'J0115', 'Problem solving skills and an analytical focus'),
	('NULL', 'J0115', 'Understanding of legal security requirements'),
	('NULL', 'J0201', 'Industry certifications in cybersecurity'),
	('NULL', 'J0201', 'Skills in automation and event detection'),
	('NULL', 'J0302', 'A relevant degree in either cybersecurity or human resources'),
	('NULL', 'J0302', 'Knowledge of attack simulations and their ethical use');
	");
}
